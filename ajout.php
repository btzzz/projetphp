...
<head>
    ...
    <link rel="stylesheet" href="coiffeur.css">

    <title>Ajout de coiffeur</title>
</head>
...
$suppression=$db->query("DELETE FROM coiffeurbutez WHERE id='$id'");
...
if(isset($_POST["envoi"])){
    ...
    $coiffeurs=$db->query("SELECT * FROM coiffeurbutez");
